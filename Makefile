...
RAZVAN_LIBS= 	$(RAZVAN_DIR_C)/omega_stub.o $(RAZVAN_DIR_C)/Exit.o \
		$(RAZVAN_DIR_HS)/Omega_stub.o $(RAZVAN_DIR_HS)/Omega_util.o	\
		$(RAZVAN_DIR_HS)/Omega.o $(RAZVAN_DIR_HS)/PFOmega.o $(RAZVAN_DIR_HS)/Omega_types.o $(RAZVAN_DIR_HS)/Omega_tokens.o	\
		$(RAZVAN_DIR_HS)/Omega_lexer.o $(RAZVAN_DIR_HS)/Omega_parser.o
